...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=#1F000B
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=#ff1163
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
    TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
        ...
        #"xkb_layout 125 117"
        # "date_day 235 136"
        "date_day #000000 #ffffff"
        "date #000000 #ffffff ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
        "time #000000 #ffffff ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
